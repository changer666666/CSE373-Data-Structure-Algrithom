...
public class LinkedIntList {
     ...
     */
    public static <Listnode> LinkedIntList concatenated(LinkedIntList A, LinkedIntList B) {
        if (A == null || A.front == null) {
            return B;
        } else if (B == null || B.front == null) {
            return A;
        } else {
            ListNode p = A.front;
            ListNode front = new ListNode(p.data, null);
            ListNode back = front;
            while (p.next != null) {
                p = p.next;
                back.next = new ListNode(p.data, null);
                back = back.next;
            }
            back.next = B.front;
            return new LinkedIntList(front);
